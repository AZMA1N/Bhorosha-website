...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-off-white relative overflow-hidden">
            {/* Header with Logo */}
            ...
            <div className="flex-1 flex items-center justify-center container mx-auto px-4 z-10">
